...
{{/*
Get valkey/redis service name (bitnami/valkey aliased as redis)
*/}}
...
{{- else -}}
{{- printf "%s-%s-primary" .Release.Name (default "redis" .Values.redis.nameOverride | trunc 63 | trimSuffix "-") -}}
{{- end -}}
{{- end -}}

{{/*
Get valkey/redis service port
*/}}
{{- define "litellm.redis.port" -}}
{{- if .Values.redis.sentinel.enabled -}}
{{ .Values.redis.sentinel.service.ports.sentinel }}
{{- else -}}
{{ .Values.redis.primary.service.ports.redis | default 6379 }}
{{- end -}}
{{- end -}}
